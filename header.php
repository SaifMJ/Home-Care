...
<h5 class="notification-user">Md.Saiful Alam</h5>
...
<!--
<li class="header-notification" onclick="window.open('https://www.youtube.com/channel/UCY-1tOG0Saur-vT7VerOByg?view_as=subscriber','_newtab');">
<div class="dropdown-primary dropdown">
